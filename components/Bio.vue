<template>
    ...
    <div class="flex items-center gap-x-3 my-5">
        <p class=" text-teal-700 rounded font-mono">Bio</p>
        <div class="border-t border-gray-600 w-full"></div>
    </div>
    <div class="flex flex-col  w-full gap-y-3 me-20 text-base text-slate-300">
    
        <p> Greetings! I'm <span class="text-white font-medium">Joseph Kwaku Ampah</span>, a passionate individual with a flair for crafting engaging digital experiences. My journey in the tech world began with a fascination for <span class="text-white font-medium">web developemnt</span>, and over time, I've honed my skills to a mid-level proficiency. <span class="text-white font-medium">The art of transforming ideas into interactive websites</span>  is where my heart truly lies.</p>
